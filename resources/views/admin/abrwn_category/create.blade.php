...
@section('title', 'Create Abrwn Category')
@section('content')
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Create Abrwn Category</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('user.dashboard') }}">Home</a>
                                </li>
                                <li class="breadcrumb-item active">Create Abrwn Category
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="card p-2">
                        <div class="card-header">
                            <div class="head-label">
                                <h5 class="mb-0">Create Abrwn Category</h5>
                        ...
                        <div class="card-body">
                            <form action="{{ route('abrwn.category.store') }}" method="POST"
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="d-flex flex-column mb-2">
                                                            ...
                                                            <div class="form-check form-switch form-check-success">
                                                                ...
                                                                @if (old('is_article') == '1') checked @endif  />
                                                        ...
                                                        <div class="d-flex flex-column mb-2">
                                                            ...
                                                            <div class="form-check form-switch form-check-success">
                                                                <input type="checkbox" class="form-check-input"
                                                                    ...
                                                                    value="1"  @if (old('is_blog') == '1') checked @endif  />
                                                        ...
                                                        <div class="d-flex flex-column mb-2">
                                                            ...
                                                            <div class="form-check form-switch form-check-success">
                                                                <input type="checkbox" class="form-check-input"
                                                                    ...
                                                                    value="1"  @if (old('is_review') == '1') checked @endif  />
                                                        ...
                                                        <div class="d-flex flex-column mb-2">
                                                            ...
                                                            <div class="form-check form-switch form-check-success">
                                                                <input type="checkbox" class="form-check-input"
                                                                    ...
                                                                    value="1"  @if (old('is_writeup') == '1') checked @endif  />
                                                        ...
                                                        <div class="d-flex flex-column mb-2">
                                                            ...
                                                            <div class="form-check form-switch form-check-success">
                                                                <input type="checkbox" class="form-check-input"
                                                                    ...
                                                                    value="1"  @if (old('is_news') == '1') checked @endif  />
