                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="d-flex flex-column mb-2">
                                                            ...
                                                            <div class="form-check mb-1">
                                                                <input class="form-check-input" type="radio"
                                                                    ...
                                                                    value="part_section" {{old('format', $law->format)=="part_section" ? 'checked' : '' }}>
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    ...
                                                                    value="chapter_section" {{old('format', $law->format)=="chapter_section" ? 'checked' : '' }}>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="d-flex flex-column mb-2">
                                                            ...
                                                            <div class="form-check mb-1">
                                                                <input class="form-check-input" type="radio"
                                                                    name="lang" id="bn" value="bn" {{old('lang', $law->lang)=="bn" ? 'checked' : '' }}>
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="lang" id="both" value="both" {{old('lang', $law->lang)=="both" ? 'checked' : '' }}>
                                                            ...
                                                            <div class="d-flex flex-column mb-2">
                                                                ...
                                                                <div class="form-check mb-1">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        value="bn" {{old('default_lang', $law->default_lang)=="bn" ? 'checked' : '' }}>
