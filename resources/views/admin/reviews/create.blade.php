        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Create Review</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('user.dashboard') }}">Home</a>
                                </li>
                                <li class="breadcrumb-item active">Create Review
                                </li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <select id="review_category_id" name="review_category_id"
                                                ...
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}" {{old('review_category_id') ? 'selected' : ''}} >{{ $category->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="date" name="last_update" class="form-control @error('last_update') is-invalid @enderror"
                                                value="{{ old('last_update', $article->last_update) }}">
