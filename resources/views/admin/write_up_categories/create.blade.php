...
@section('title', 'Create Write Up Category')
@section('content')
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Create Write Up Category</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('user.dashboard') }}">Home</a>
                                </li>
                                <li class="breadcrumb-item active">Create Write Up Category
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="card p-2">
                        <div class="card-header">
                            <div class="head-label">
                                <h5 class="mb-0">Create Write Up Category</h5>
                            </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('write_up.categories.store') }}" method="POST"
