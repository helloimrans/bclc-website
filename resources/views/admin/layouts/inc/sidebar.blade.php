...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        @if (auth()->user()->email == 'law.user@gmail.com' || auth()->user()->email == 'law.user2@gmail.com')
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="@if ($route == 'user.dashboard') active @endif nav-item"><a
                        class="d-flex align-items-center" href="{{ route('user.dashboard') }}"><i
                ...
                <li class="nav-item"><a class="d-flex align-items-center" href="#"><i
                            class="fa fa-gavel"></i><span class="menu-title text-truncate" data-i18n="Laws & Rules">Laws
                            & Rules</span></a>
        ...
        @else
            ...
            ------------------------------ --}}
                    <li class="nav-item"><a class="d-flex align-items-center" href="#"><i
                                class="far fa-eye"></i><span class="menu-title text-truncate"
                                data-i18n="Roles &amp; Permission">Legal
                                Insights</span></a>
                        <ul class="menu-content">
                    ...
                    <li class="nav-item"><a class="d-flex align-items-center" href="#"><i
                        ...
                        <ul class="menu-content">
                            ...
                            <li class=" @if ($route == 'service.consultation.request') active @endif"><a
                                    ...
                                    href="{{ route('service.consultation.request') }}"><i
                                        data-feather="circle"></i><span class="menu-item text-truncate"
                                        data-i18n="Permission">Consultation
                                        Request</span></a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item"><a class="d-flex align-items-center" href="#"><i
                        ...
                        <ul class="menu-content">
                            ...
                            <li class="@if (in_array($route, ['write_up.categories.index', 'write_up.categories.edit', 'write_up.categories.create'])) active @endif"><a
                                    class="d-flex align-items-center"
                                    href="{{ route('write_up.categories.index') }}"><i
                                        data-feather="circle"></i><span class="menu-item text-truncate"
                                        data-i18n="Roles">Category</span></a>
                            </li>
                        </ul>
                    ...
                    <li class="nav-item"><a class="d-flex align-items-center" href="#"><i
                        ...
                        <ul class="menu-content">
                            ...
                            <li class="@if (in_array($route, ['document.categories.index', 'document.categories.edit', 'document.categories.create'])) active @endif"><a
                                    class="d-flex align-items-center"
                                    href="{{ route('document.categories.index') }}"><i
                                        data-feather="circle"></i><span class="menu-item text-truncate"
                                        data-i18n="Roles">Category</span></a>
                            </li>
                            <li class="@if (in_array($route, ['document.subcategories.index', 'document.subcategories.edit', 'document.subcategories.create'])) active @endif"><a
                                    class="d-flex align-items-center"
                                    href="{{ route('document.subcategories.index') }}"><i
                                        data-feather="circle"></i><span class="menu-item text-truncate"
