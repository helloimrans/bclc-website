                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Edit Service Category
                                </li>
                            </ol>
                        </div>
                    </div>
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <div class="form-check form-switch form-check-success">
                                                                <input type="checkbox" class="form-check-input"
                                                                    id="customSwitch10" value="1"
                                                                    name="is_service" @if (old('is_service', $category->is_service) == '1') @checked(true) @endif  />
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <div class="form-check form-switch form-check-success">
                                                                <input type="checkbox" class="form-check-input"
                                                                    ...
                                                                    value="1" @if (old('is_pro_bono', $category->is_pro_bono) == '1') @checked(true) @endif   />
