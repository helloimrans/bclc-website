        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Review</h2>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="dt-action-buttons text-end">
                                <div class="dt-buttons d-inline-flex"><a href="{{ route('abrwn.review.create') }}"
                                    ...
                                    <tbody>
                                        @foreach ($abrwns as $abrwn)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="me-1"
                                                        href="{{ route('abrwn.review.edit', $abrwn->id) }}"
