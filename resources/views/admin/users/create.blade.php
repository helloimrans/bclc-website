                            ...
                            <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card card-body" style="border:2px dotted #ddd; background:#fafafa"
                                    ...
                                    <div class="d-flex mb-2">
                                        <a href="#" class="me-25">
                                            <img src="{{ asset('defaults/avatar/avatar.png') }}" id="upImg1"
                                                class="upImg1 rounded me-50" alt="profile image" height="100"
                                                width="100" />
                                        </a>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-1">
                                                ...
                                                <select id="is_service" name="gender"
                                                    ...
                                                    <option value="Others"
                                                        @if (old('gender') == 'Others') selected @endif>
                                                        Others
                                                    </option>
                                                </select>
                                                @error('gender')
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <select id="marital_status" name="marital_status"
                                                    ...
                                                    <option value="Married"
                                                        @if (old('marital_status') == 'Married') selected @endif>
                                                        Married
                                                    </option>
                                                    <option value="Unmarried"
                                                        @if (old('marital_status') == 'Unmarried') selected @endif>
                                                        Unmarried
                                                    </option>
                                                </select>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <textarea name="address" class="form-control @error('address') is-invalid @enderror"
                                            placeholder="Enter present location...">{{ old('address') }}</textarea>
                                        @error('address')
                                            <div class="text-danger"><small>{{ $message }}</small></div>
                                        @enderror
                                    </div>
                                        ...
                                        <div class="regi-expert-role mb-1">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="is_lawyer"
                                                    ...
                                                    @if (old('is_consultant') == '1') checked @endif>
                                        ...
                                        <div class="regi-expert-role mb-1">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="is_trainer"
                                                    ...
                                                    @if (old('is_trainer') == '1') checked @endif>
                                        ...
                                        <div class="regi-expert-role">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="is_writer"
                                                    ...
                                                    @if (old('is_writer') == '1') checked @endif>
