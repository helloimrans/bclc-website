                            ...
                            <div class="card-body">
                                <div class="user-avatar-section">
                                    <div class="d-flex align-items-center flex-column">
                                        <img class="img-fluid rounded mt-3 mb-2"
                                            src="@if ($expert->image) {{ Storage::url($expert->image) }}
                                            @else
                                ...
                                <div class="d-flex justify-content-around my-2 pt-75">
                                    <div class="d-flex align-items-start me-2">
                                        ...
                                        <div class="ms-75">
                                            <h4 class="mb-0">{{ $expert->total_view }}</h4>
                    ...
                    <div class="col-xl-8 col-lg-7 col-md-7">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('expert.edit.profile') }}" class="btn btn-primary btn-sm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-12">
                                        <dl class="row mb-0">
                                            ...
                                            <dd class="col-sm-8 mb-1">{{ $expert->current_institution }}</dd>

                                            <dt class="col-sm-4 fw-bolder mb-1">Subject:</dt>
                                            <dd class="col-sm-8 mb-1">{{ $expert->current_subject }}</dd>

                                            <dt class="col-sm-4 fw-bolder mb-1">Qualification:</dt>
                                            <dd class="col-sm-8 mb-1">{{ $expert->highest_qualification }}</dd>

                                            <dt class="col-sm-4 fw-bolder mb-1">Present Location:</dt>
                                            <dd class="col-sm-8 mb-1">{{ $expert->present_location }}</dd>

                                            <dt class="col-sm-4 fw-bolder mb-1">Permanent Address:</dt>
                                            <dd class="col-sm-8 mb-1">{{ $expert->permanent_address }}</dd>

                                            <dt class="col-sm-4 fw-bolder mb-1">About:</dt>
                                            <dd class="col-sm-8 mb-1">{{ $expert->about }}</dd>
